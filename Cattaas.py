...
def load_image(url):
    try:# обработка исключений
        ...
        response = requests.get(url)# делаем запрос и получаем ответ,
#get-команда для получения чего либо
        ...
        return ImageTk.PhotoImage(img)# функция вернет img и положит
# ниже в img = load_image(url)
